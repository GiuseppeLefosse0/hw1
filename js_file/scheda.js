...
function displayEsercizi(json){
    ...
    function inizialize() {
        ...
        fetch('http://localhost/hw1/fetch_inizialize.php', {
            method: 'POST',
            headers: {
    ...
    function ae1(){
        ...
        fetch('fetch_aggiungiEsercizio.php', {
        method: 'POST',
        headers: {
    ...
    function re1(){
        ...
        fetch('fetch_rimuoviEsercizio.php', {
        method: 'POST',
        headers: {
